      ...
      layout.push(<TouchableOpacity
        onPress={() => this.props.navigator.push({
          component: HeatUserDetails, passProps: {
            ...
            addr:this.props.community_name+this.props.building_name+this.props.unit_name
          }
        })}
        style={{
    ...
    return (
      <View style={styles.all}>
        <View style={styles.navView}>
          ...
          <Text style={styles.topNameText}>{this.props.unit_name}</Text>
          <TouchableOpacity style={styles.toolbar} onPress={() => this.setState({ modal: true })}>
            <Text style={styles.toolbarText}>温度说明</Text>
          </TouchableOpacity>
        </View>
        <Text style={{ backgroundColor: "#434b59", textAlign: "center", width: width, height: 25, color: "#FFFFFF", fontSize: 12 }}>{this.props.community_name}{this.props.building_name}</Text>
