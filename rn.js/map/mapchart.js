...
export default class MapChart extends Component {
    ...
    constructor(props) {
        ...
        AsyncStorage.getItem("access_token", function (errs, result) {
            if (!errs) {
                console.log(_this.state.url +result+"&_id="+props._id+"&tag_id="+props.tag+"&level="+props.level+"&start_time=2017$04$20&end_time=2017$04$31");
                fetch(_this.state.url +result+"&_id="+props._id+"&tag_id="+props.tag+"&level="+props.level+"&start_time=2017$04$20&end_time=2017$04$31")
