            ...
            <View style={styles.all}>
                ...
                <View style={styles.topView}>
                    ...
                    <TouchableOpacity style={styles.all} onPress={this._switch.bind(this, 2,false)}>
                        <View style={styles.topViewItem}>
                            <Text style={this.state.topStyle3}>操作日志</Text>
                        </View>
                        <View style={this.state.topStyleView3}></View>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.all} onPress={this._switch.bind(this, 3,false)}>
                        <View style={styles.topViewItem}>
                            <Text style={this.state.topStyle4}>换热站档案</Text>
                        </View>
                        <View style={this.state.topStyleView4}></View>
                    </TouchableOpacity>
                </View>
