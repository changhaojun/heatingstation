...
import {View, Text, Image, TextInput, Navigator, StyleSheet, TouchableHighlight, StatusBar, ListView,
    TouchableOpacity, Modal, Picker,} from 'react-native';

import Dimensions from 'Dimensions';
var { width, height } = Dimensions.get('window');

import HeatStation from './heat_station.android';
        ...
        return (
            <View style={styles.all}>
                ...
                <View style={styles.selectView}>
                    <Text style={{fontSize:16, color: '#ffba00'}}>当前指标：{this.state.selectedCourse}</Text>
                            ...
                            renderRow={(rowData) => {
                                return(
                                    ...
                                    <View style={styles.listItemChild}>
                                        ...
                                        <View style={styles.listItemChild1}>
                                            <Text style={styles.data_valueText}>{rowData.data_value}</Text>
                                        </View>
                                        <View style={styles.listItemChild1}>
